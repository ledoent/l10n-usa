...
class TestSourcing(UsTaxBaseTest):
    ...
    def test_destination_based_state_keeps_buyer_zip(self):
        ...
        self.assertEqual(
            self.service._sourcing_zip(self.company.id, "33101", "FL"), "33101"
        )
    ...
    def test_origin_based_intrastate_uses_seller_zip(self):
        ...
        self.assertEqual(
            self.service._sourcing_zip(self.company.id, "77001", "TX"), "75001"
        )
    ...
    def test_origin_based_interstate_keeps_buyer_zip(self):
        ...
        self.assertEqual(
            self.service._sourcing_zip(self.company.id, "77001", "TX"), "77001"
        )
    ...
    def test_ca_excluded_from_origin_sourcing(self):
        ...
        self.assertEqual(
            self.service._sourcing_zip(self.company.id, "90210", "CA"), "90210"
        )
